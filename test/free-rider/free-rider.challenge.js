...
describe("[Challenge] Free Rider", function () {
  ...
  before(async function () {
    ...
    this.uniswapRouter = await new ethers.ContractFactory(routerJson.abi, routerJson.bytecode, deployer).deploy(this.uniswapFactory.address, this.weth.address);
  ...
  it("Exploit", async function () {
    const FreeRiderAttackerFactory = await ethers.getContractFactory("FreeRiderAttacker");

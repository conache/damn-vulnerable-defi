...
contract Exchange is ReentrancyGuard {
    ...
    function buyOne() external payable nonReentrant returns (uint256) {
        ...
        // @potential - buying an NFT for a really small price
        // manipulating the price so that it's equal to the exchange contract balance
        ...
        // underflow - if applied, reverts the tx
